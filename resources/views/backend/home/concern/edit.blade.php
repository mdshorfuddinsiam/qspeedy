...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
      <!--begin::Title-->
      <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Concern Edit</h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
...
@section('content')
	...
	<div class="card shadow-sm">
	    <div class="card-header">
	        <h3 class="card-title">Concern Edit</h3>
	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.concerns.update', $concern->id) }}" method="POST" enctype="multipart/form-data">
	    		@csrf
	    		@method('PUT')
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
	    		    ...
	    		    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $concern->image ? asset($concern->image) : asset('/uploads/no_image.jpg') }});"></div>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0 @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title') ?? $concern->title }}" />
	    		  <!--end::Input-->
	    		  @error('title')
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <select name="status" class="form-select form-select-solid @error('status') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
	    		      <option></option>
	    		      <option {{ old('status', $concern->status) == "1" ? 'selected' : '' }} value="1">Active</option>
	    		      <option {{ old('status', $concern->status) == "0" ? 'selected' : '' }} value="0">Inactive</option>
	    		  </select>
	    		  @error('status')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
