	...
	<div class="card">
	  ...
	  <div class="card-header border-0 pt-6">
	    ...
	    <div class="card-toolbar">
	    	<a href="{{ route('admin.concerns.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Concern Create</a>
	    </div>
	    <!--end::Card toolbar-->
	  </div>
	  <!--end::Card header-->
	  	    ...
	  	    <tbody>
	  	        ...
	  	        <tr>
                    ...
                    <td>{{ $row->title }}</td>
	  	            ...
	  	            <td>
	  	            	<a href="{{ route('admin.concerns.edit', ['concern' => $row->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-edit	"></i></a>
	  	            	<a href="{{ route('admin.concern.delete', ['concern' => $row->id]) }}" class="btn btn-sm btn-danger delete"><i class="fas fa-trash"></i></a>
	  	            </td>
	  	        </tr>
	  	        @endforeach
	  	    </tbody>
