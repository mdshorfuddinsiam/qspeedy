...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
      <!--begin::Title-->
      <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Area Create</h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.areas.store') }}" method="POST" enctype="multipart/form-data">
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <textarea name="address" id="address" cols="30" class="form-control form-control-solid mb-3 mb-lg-0 @error('address') is-invalid @enderror" rows="5" placeholder="Address">{{ old('address') }}</textarea>
	    		  <!--end::Input-->
	    		  @error('address')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
                ...
                <div class="fv-row mb-7">
                  ...
                  <!--end::Label-->
                  <!--begin::Input-->
                  <input type="text" name="map_link" class="form-control form-control-solid mb-3 mb-lg-0 @error('map_link') is-invalid @enderror" placeholder="Map Link" value="{{ old('map_link') }}" />
                  <!--end::Input-->
                  @error('map_link')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
